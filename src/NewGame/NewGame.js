...
export const NewGame = () => {
  return (
    <section id="new-game" className="column">
      ...
      <div className="blur">
        <p>
          You have 1 minute to guess as many hate-symbols as you can. Each
          correct answer will take you straight to the next card, while
          incorrect answers will flip the card to allow you to learn about that
