    ...
    <section id="about" className="column">
      ...
      <div className="blur">
        ...
        <p>
          ...
          inspire my country to recognize the threat posed by fascist & white
          supremacist ideologies and organizations. Use this app as a tool to
          quickly recognize the signs & symbols of these increasingly bold
          hate-groups. You may be unpleasantly surprised how many are present in
          plain view on any given day.
        </p>
        <p>
